        ...
        <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <h2 style="text-muted"><span class="glyphicon glyphicon-shopping-cart"></span> Data Isi Keranjang</h2>
                    ...
                    if(@$_GET['pesan']=="checkoutBerhasil"){
                    ...
                    if(@$_GET['pesan']=="checkoutGagalKurang"){

                    ?>
                            <div class="alert alert-warning">
                            Checkout Gagal! Nominal Pembayaran Kurang!
                            </div>
                    <?php
                    ...
                    <table class="table table-bordered table-hover" id="data-table">
                        ...
                        while($row= $sql->fetch_assoc()){
                            echo '<div class="modal fade" id="checkoutModal_' . $row['keranjang_id'] . '" tabindex="-1" role="dialog" aria-labelledby="checkoutModalLabel">
                                      <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  ...
                                                  <h4 class="modal-title" id="checkoutModalLabel">Checkout: ' . htmlspecialchars($row['nama_barang']) . '</h4>

                                              </div>
                                            <form method="post" action="update_checkout.php">  
                                            ...
                                            <br>
                                                  ...
                                                  <input type="number" class="form-control" id="payment_' . $row['keranjang_id'] . '"  name="payment"  required>
                                                  </br>
                                              </div>
                                ...
                                echo '<div class="modal fade" id="detailKeranjangModal_' . $row['keranjang_id'] . '" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel">
                                          <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                  ...
                                                  <div class="modal-body">
                                                      ...
                                                      <p><strong>Total Barang:</strong> Rp.' . number_format($row['total_harga'], 2, ',', '.') . '</p>                                                      
                                                  </div>
                                                  <div class="modal-footer">
                                                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                  </div>
                        ...
                        <tr>
                            ...
                            <td>                         
                                <a data-toggle="modal" data-target="#detailKeranjangModal_<?php echo $row['keranjang_id']?>">
                                    <button class="btn btn-xs btn-info glyphicon glyphicon-info-sign"></button>
                                </a>
                                <a data-toggle="modal" data-target="#checkoutModal_<?php echo $row['keranjang_id']?>">
                                    <button class="btn btn-xs btn-success glyphicon glyphicon-check"> Checkout</button>
                                </a>          
                            </td>
                        </tr>
                        <?php } ?>
